...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="content">
            <div class="personal">
            <center><h3 style="color: brown; font-size: 35px;"> Bolsa de trabajo institucional</h3></center>
            </div>
     </div>
        ...
        <div class="flex-center position-ref">
            @if (Route::has('login'))
                <div class="top-right links">
                    ...
                    @else
                        <p align="right"><a href="{{ route('login') }}">Iniciar sesión</a></p>

                        @if (Route::has('register'))
                            <p align="right"><a href="{{ route('register') }}">Registrarse</a>
                        @endif
                    @endauth
    ...
    <div class="card">
        ...
        <center><h2 class="personal" style="color: green">Universidad Tecnólogica de Huejotzingo</h2></center>
        <div class="card-body">
