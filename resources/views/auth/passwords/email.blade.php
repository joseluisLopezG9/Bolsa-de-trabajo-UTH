...
<html>
<head>
    <title>BOLSA DE TRABAJO UTH/RESTABLECER CONTRASEÑA</title>
    ...
    <div class="container">
        <div class="row px-3">
            <div class="col-lg-10 col-xl-9 card flex-row mx-auto px-0">
                ...
                <center>
                        <h3 class="font-weight-bold py-3" style="color: green; font-size: 35px;">Bolsa de trabajo institucional</h3>
                </center>
                        ...
                        <form class="form-box px-3">
                            ...
                            <div class="mb-3">
                                <button type="submit" class="btn btn-block text-uppercase btn btn-success">
                                    {{ __('Enviar enlace para restablecer mi contraseña') }}
                                </button>
                            </div>  
